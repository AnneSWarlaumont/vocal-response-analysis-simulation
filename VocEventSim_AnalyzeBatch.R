...
colMeans(fitOrder_noTurns_nonInteractive)
colMeans(fitOrder_noTurns_a2Interactive)
colMeans(fitOrder_noTurns_bidirectional)
...
### Find out what the fitRanks are for the three simulation types for each recording
colMeans(fitOrder_wTurns_nonInteractive)
colMeans(fitOrder_wTurns_a2Interactive)
colMeans(fitOrder_wTurns_bidirectional)
