...
#
# At the moment, this code does a separate analysis for each recording
# But it would probably be more ideal to do analysis across recordings,
# with recording as a random effect.
#
# I would also like to write code to analyze the human recordings, although
# to do much with that I should get the data together for a larger dataset (n>3)
